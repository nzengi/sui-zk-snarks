module zk_snark::verifier {
    ...
    fun compute_linear_combination(
        ...
        while (i < len && i + 1 < vector::length(&ic)) {
    ...
    fun test_verify() {
        ...
        test_scenario::next_tx(scenario, admin);
        {
            ...
            // Initialize verification key with valid data first
            let fields = &mut vk.fields;
            key_types::update_fields(
                fields,
                create_test_point(),  // alpha
                create_test_point(),  // beta
                create_test_point(),  // gamma
                create_test_point(),  // delta
                vector[create_test_point(), create_test_point()]  // ic: en az 2 eleman olmalı
            );
            ...
            let public_inputs = vector[create_test_point()];
    ...
    fun create_test_point(): vector<u8> {
        ...
        let i = 0;
        while (i < utils::get_point_length()) {
