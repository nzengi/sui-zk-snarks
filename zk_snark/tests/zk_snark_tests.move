...
module zk_snark::zk_snark_tests {
    ...
    fun setup_test(test: &mut Scenario) {
        ...
        {
            verifier::init_for_testing(test_scenario::ctx(test));
            admin::init_for_testing(test_scenario::ctx(test));
        };
    }
    ...
    fun test_verification_flow() {
        ...
        test_scenario::next_tx(&mut scenario, ADMIN);
        {
            ...
            vector::push_back(&mut public_inputs, create_dummy_point(utils::get_field_element_length()));
